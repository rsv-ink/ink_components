...
RSpec.describe InkComponents::Forms::Radio::Component, type: :component do
  ...
  context "when the halper text is provided" do
    it "renders the helper text" do
      component = render_inline(described_class.new) do |radio|
        radio.with_helper_text { "Some helper text" }
      end
